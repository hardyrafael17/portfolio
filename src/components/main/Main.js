    ...
    return (
        <main>
            ...
            <div className="about-me-container">
                ...
                <h2>About Me</h2>
                <p>In software development I have finally found my passion, I'm somewhat autodidact and like learning and challenging myself with new tasks every day, for now I'm doing everything I can to get more proficient in the front end development field and have seen many directions in which I want to go, being the main goal understanding the software development cycle and and advanced understand all how machines work in the low level so that I can design software that is highly efficient.</p>
                </div>
